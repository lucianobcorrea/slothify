...
export function EditChallenge() {
  const { challenge, fetchChallenge, loadingChallenge } = useGetChallenge();
  const { id } = useParams();
  const [challengeTypeRenderSelect, setChallengeTypeRender] = useState("");
  const [challengeLabelRenderSelect, setChallengeLabelRender] = useState("");
  ...
  useEffect(() => {
      ...
      form.reset({
        ...
        requiredExercises: challenge.requiredExercises || 1,
        requiredMultipleChoiceExercises:
          challenge.requiredMultipleChoiceExercises || 1,
        requiredSortingExercises: challenge.requiredSortingExercises || 1,
        requiredDragAndDropExercises:
          challenge.requiredDragAndDropExercises || 1,
        requiredXp: challenge.requiredXp || 1,
        challengeTypeSelect: challengeTypeRenderSelect,
      });
    }
  }, [challenge, form, challengeTypeRenderSelect]);
  ...
  function challengeTypeRender() {
    ...
    if (challengeTypeRenderSelect) {
      setChallengeTypeLabel(challengeLabelRenderSelect);
